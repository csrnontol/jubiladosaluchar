...
var widgStylesheet = "../../tools/widgEditor/css/widgContent.css";
...
widgSelectBlockOptions.push("", "- tipo de contenido -");
// widgSelectBlockOptions.push("<h1>", "Heading 1");
widgSelectBlockOptions.push("<h2>", "Título");
widgSelectBlockOptions.push("<h3>", "Subtítulo");
widgSelectBlockOptions.push("<h4>", "Subtítulo menor");
// widgSelectBlockOptions.push("<h5>", "Heading 5");
// widgSelectBlockOptions.push("<h6>", "Heading 6");
widgSelectBlockOptions.push("<p>", "Párrafo");
...
function widgToolbar(theEditor)
{
	...
	for (var i = 0; i < widgToolbarItems.length; i++)
	{
		...
		{
			case "bold":
				this.addButton(this.theList.id + "ButtonBold", "widgButtonBold", "Negritas", "bold");
			...
			case "hyperlink":
				this.addButton(this.theList.id + "ButtonLink", "widgButtonLink", "Hypervínculo", "link");
				
				break;
				
			case "unorderedlist":
				this.addButton(this.theList.id + "ButtonUnordered", "widgButtonUnordered", "Viñetas", "insertunorderedlist");
				
				break;
				
			case "orderedlist":
				this.addButton(this.theList.id + "ButtonOrdered", "widgButtonOrdered", "Numeración", "insertorderedlist");
		...
		case "image":
			...
			if (theImage != null && theImage != "")
			{
				...
				if (theIframe.contentWindow.document.selection)
				{
					...
					theRange.pasteHTML("<images alt=\"" + theAlt + "\" src=\"" + theImage + "\" />");
				...
				else
				{
					...
					var theImageNode = theIframe.contentWindow.document.createElement("images");
...
{
	var elementList = new Array("#text", "a", "em", "h1", "h2", "h3", "h4", "h5", "h6", "images", "li", "ol", "p", "strong", "ul");
